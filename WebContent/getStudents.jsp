...
<%
	...
	//3단계 sql
	String sql = "select STUDENT_NO,STUDENT_NAME,STUDENT_ADDR,STUDENT_PHONE,STUDENT_BIRTH, STUDENT_BIRTH,STUDENT_EMAIL,STUDENT_ID,STUDENT_PW, "+
	             " (select count(*) from register_tbl_01 where student_no = STUDENT_TBL_01.STUDENT_NO ) as register_cnt "+
	...
	while(rs.next()) {	
		...
		%>				
				<tr>
					<td style="text-align: center;"><a href="updateStudents.jsp?student_no=<%=rs.getString("STUDENT_NO")%>"><%=rs.getString("STUDENT_NO") %></a></td>
